    ...
    <div className="bg-background text-on-surface font-body-md overflow-x-hidden pb-12">
      ...
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-32 overflow-hidden">
        ...
        <div className="relative z-20 max-w-container-max mx-auto px-margin-desktop">
          <div className="max-w-3xl">
            <h1 className="font-display-lg text-[38px] sm:text-[44px] md:text-[64px] text-on-surface leading-tight mb-stack-md">
              Twoja podróż <br />
              <span className="text-primary">zaczyna się tutaj</span>
            </h1>
            <p className="font-body-lg text-[16px] sm:text-[18px] md:text-[24px] text-on-surface-variant mb-stack-lg leading-relaxed">
            ...
            <button
              ...
              className="text-on-primary font-label-lg py-4 px-10 shadow-lg hover:brightness-110 active:scale-98 transition-all flex items-center justify-center gap-3 rounded-full bg-primary text-base font-semibold"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          {popularCars[0] ? (
            <div
              ...
              onClick={() => handleRentCar(popularCars[0])}
            >
                ...
                <div className="p-stack-md flex justify-between items-center">
                  <div>
                    <h3 className="font-headline-sm text-headline-sm">
                      {popularCars[0].brandName ?? popularCars[0].brandname}{" "}
                      {popularCars[0].modelName ?? popularCars[0].modelname}
                    </h3>
                    <p className="font-body-md text-on-surface-variant">
                      Najpopularniejszy wybór kierowców.
                    </p>
                  </div>
                  <div className="text-right">
                    <span className="block font-label-sm text-on-surface-variant">
                      Stawka
                    </span>
                    <span className="text-primary font-headline-sm">
                      {popularCars[0].hourlyCost ?? popularCars[0].hourlycost}{" "}
                      PLN / godz.
                    </span>
                  </div>
                </div>
            ...
            <div className="md:col-span-8">
              <div className="bg-surface-container-low rounded-[1.5rem] border border-outline-variant h-[420px] flex flex-col items-center justify-center p-6 text-center shadow-inner">
                <span className="material-symbols-outlined text-error text-6xl mb-4 font-bold">
                  close
                </span>
                <h3 className="font-headline-sm text-on-surface font-bold">
                  Brak pojazdu w bazie
                </h3>
          ...
          {popularCars[1] ? (
            <div
              ...
              onClick={() => handleRentCar(popularCars[1])}
            >
              <div className="bg-white rounded-[1.5rem] h-full overflow-hidden shadow-lg border border-outline-variant transition-all hover:-translate-y-1 flex flex-col">
                <div className="relative flex-grow min-h-[200px] overflow-hidden">
                  <img
                    className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                    alt={`${popularCars[1].brandName ?? popularCars[1].brandname} ${popularCars[1].modelName ?? popularCars[1].modelname}`}
                    src={
                      popularCars[1].imageUrl ||
                      popularCars[1].imageurl ||
                      "https://lh3.googleusercontent.com/aida-public/AB6AXuAJi20c0is2aWJkHVPjFgO3PjQ0L9OFcHm-emUMTjh_BVyZ-thiVsn-EfKhVTGRRyNaSxS6oLnOV4PZ7YgiLZkyPn8WYeSWo0px2MfCcwdNl3dvg6n9fU-4WssfNiGrjKOGT24KrFOZa5_v4iYn0nPPgZTEKsjG4NuSOiEfv2nm4j-mt_TEnsxJH3O5WczcMWxXoPNERXBhqzbt0Yv64BcvKLIQ8N_bihMnG5An5Z-kBSm7fN45-yCllzPl-LIoMEnM__-b0pba1os6"
                    }
                  />
                </div>
                <div className="p-stack-md flex justify-between items-center">
                  <div>
                    <h3 className="font-headline-sm text-headline-sm text-lg">
                      {popularCars[1].brandName ?? popularCars[1].brandname}{" "}
                      {popularCars[1].modelName ?? popularCars[1].modelname}
                    </h3>
                    <p className="font-body-sm text-on-surface-variant">
                      {popularCars[1].bodyType ??
                        popularCars[1].bodytype ??
                        "Premium"}
                    </p>
                  </div>
                  <div className="text-right">
                    ...
                    <span className="text-primary font-headline-sm text-lg">
                      {popularCars[1].hourlyCost ?? popularCars[1].hourlycost}{" "}
                      PLN / godz.
                    </span>
                  </div>
                </div>
          ...
          {popularCars[2] ? (
            <div
              className="md:col-span-4 group cursor-pointer"
              onClick={() => handleRentCar(popularCars[2])}
            >
              <div className="bg-white rounded-[1.5rem] overflow-hidden shadow-lg border border-outline-variant transition-all hover:-translate-y-1">
                ...
                <div className="p-stack-md">
                  <h3 className="font-headline-sm text-lg">
                    {popularCars[2].brandName ?? popularCars[2].brandname}{" "}
                    {popularCars[2].modelName ?? popularCars[2].modelname}
                  </h3>
                  <p className="font-body-sm text-on-surface-variant">
                    {popularCars[2].hourlyCost ?? popularCars[2].hourlycost} PLN
                    / godz.
                  </p>
                </div>
              </div>
          ...
          <div className="md:col-span-8 bg-primary-container/5 rounded-[1.5rem] border-2 border-dashed border-primary/20 flex items-center justify-center p-stack-lg text-center">
            <div>
              ...
              <p className="font-body-md text-on-surface-variant mb-4 font-semibold">
                Sprawdź naszą kompletną ofertę aut osobowych, sportowych i
                SUV-ów.
              </p>
              <button
                onClick={handleGoToCars}
                className="bg-secondary text-on-secondary px-8 py-3 rounded-xl font-label-md shadow-lg hover:brightness-105 active:scale-95 transition-all"
              >
      ...
      <section className="bg-surface-container-low py-20 mt-20">
        <div className="max-w-container-max mx-auto px-margin-desktop text-center">
          <h2 className="font-headline-md text-headline-md text-on-surface mb-8 font-bold">
            Opinie naszych klientów
          </h2>
          <p className="font-body-lg text-on-surface-variant font-semibold">
            Wkrótce udostępnimy doświadczenia naszych kierowców!
          </p>
        </div>
      </section>
    </div>
